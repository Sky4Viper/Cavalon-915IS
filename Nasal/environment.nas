...
var splash_vec_loop = func
{
  ...
  var frostNormInside = getprop("/environment/aircraft-effects/frost-inside");
    ...
    ACRunning = getprop("controls/engines/engine/master-bat") == TRUE and getprop("controls/ventilation/airconditioning-enabled") == TRUE;
    ...
    hotAirOnWindshield = getprop("controls/engines/engine/master-bat")== TRUE?AntiIce:0;
	...
	pilotDoorPos = getprop("sim/model/door-positions/crew/position-norm");
  copilotDoorPos = getprop("sim/model/door-positions/passenger/position-norm");
	canopyPos = pilotDoorPos + copilotDoorPos;
